        ...
        <section className="mb-8 flex flex-col items-center text-center">
          <div className="mb-4">
            {user.avatarUrl ? (
              ...
              <div
                className={cn(
                  "flex h-20 w-20 sm:h-24 sm:w-24 items-center justify-center rounded-full bg-gradient-to-br text-xl sm:text-2xl font-bold text-white",
                  theme.gradientFrom,
                  theme.gradientTo
                )}
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {products.map((product) => (
                <div
                  key={product.id}
                  className={cn(
                    "group overflow-hidden rounded-xl border bg-card transition-all hover:shadow-md",
            ...
            <div className="flex flex-col gap-2">
              {links.map((link) => (
                <a
                  ...
                  className={cn(
                    "flex items-center justify-between rounded-lg border bg-card px-4 py-3 transition-colors hover:bg-accent",
